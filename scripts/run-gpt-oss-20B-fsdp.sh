...
CKPT_ARGS=(
   --hf-checkpoint /data/users/shared/models/openai/gpt-oss-20b-bf16
   --load /root/gpt-oss-20B-fsdp/
   --ref-load /data/users/shared/models/openai/gpt-oss-20b-bf16
...
MISC_ARGS=(
   ...
   --colocate 
   --use-fault-tolerance
   --dump-details /root/shared_data/gpt-oss-20B-fsdp-1116-noref/dump_details
   # --fsdp-cpu-offload
)
