...
CKPT_ARGS=(
   --hf-checkpoint /data/users/shared/models/zai-org/GLM-4.5-Air
   --ref-load /data/users/shared/models/zai-org/GLM-4.5-Air_torch_dist/
)
...
# "GLOO_SOCKET_IFNAME": "${VC_SOCKET_IFNAME}",
#         "TP_SOCKET_IFNAME": "${VC_SOCKET_IFNAME}",
# "OMPI_MCA_oob_tcp_if_include": "${MLP_SOCKET_IFNAME}",
#         "OMPI_MCA_btl_tcp_if_include": "${MLP_SOCKET_IFNAME}"

# --runtime-env-json='{
#      "env_vars": {
#         "no_proxy": "localhost,127.0.0.1,0.0.0.0,blp-glm-45-master-0.blp-glm-45",
#         "MASTER_ADDR": "blp-glm-45-master-0.blp-glm-45",
...
RUNTIME_ENV_JSON="{
  \"env_vars\": {
   ...
   # --save-debug-rollout-data ~/github-slime/data.pt \
   # --load-debug-rollout-data ~/github-slime/data.pt \
   # --debug-train-only \
