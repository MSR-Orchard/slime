...
CKPT_ARGS=(
   --hf-checkpoint /data/users/shared/models/Qwen3-30B-A3B-Thinking-2507
   --load /root/Qwen3-30B-A3B_slime/
   --ref-load /data/users/shared/models/Qwen3-30B-A3B-Thinking-2507
)
...
WANDB_ARGS=(
   --use-wandb
   --wandb-project slime
   --wandb-group Qwen3-30B-A3B-Thinking-2507
...
MISC_ARGS=(
   ...
   --rollout-num-gpus 4
   # --colocate # seems not working for b200
   --use-fault-tolerance
