...
Usage of this script:
    ...
    --task-file examples/orchard_gui/env/tasks/webvoyager_val.jsonl \
...
from examples.orchard_gui.reward_browser import (
    _TOOLS_INFO,
...
async def _score_single(args: Any, sample: Sample) -> float | None:
    ...
    # Detect from the model config (not the path string): a lowercase checkpoint
    # path silently fell back to qwen25 and zeroed every webvoyager score.
