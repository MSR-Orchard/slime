...
# Allow running as a script (`python examples/orchard_gui/env/clients/browser_use_env.py
# --cleanup`) in addition to `python -m examples.orchard_gui.env.clients.browser_use_env`.
...
# ---------------------------------------------------------------------------
# CLI entry point: python -m examples.orchard_gui.env.clients.browser_use_env --cleanup
# ---------------------------------------------------------------------------
